        ...
        if (amount !== "" && rate !== "") {
            ...
            if (Number(formatedAmount) && Number(calcRate) ) {
                ...
                setCommissionTab(prev => ({
                    ...prev,
                    add : {...prev.add, 
                        [name]: {...prev.add[name], commission: commission.toFixed(4), output: result.toFixed(4)}
                    }
                }))
            }
        }
        ...
        if (amount !== "" && rate !== "") {
            ...
            if (Number(formatedAmount) && Number(calcRate)) {
                ...
                setCommissionTab(prev => ({
                    ...prev,
                    remove : {...prev.remove, 
                        [name]: {...prev.remove[name], commission: commission.toFixed(4), output: result.toFixed(4)}
                    }
                }))
            }
        }
